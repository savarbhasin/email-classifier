    ...
    if (validating) {
        return (
            <div className="flex items-center justify-center min-h-screen">
                <div className="text-6xl font-extrabold text-center">Loading...</div>
            </div>
        );
    } else {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-900">
                <div className="p-8 bg-white bg-opacity-10 backdrop-blur-md rounded-2xl shadow-2xl text-white max-w-lg mx-auto">
                    ...
                    <h1 className="text-4xl font-extrabold mb-4 text-center leading-tight">
                        Welcome to<br /><span>Email Manager</span>
                    </h1>
